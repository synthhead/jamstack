...
- {id: SEMC_CLK_ROOT.outFreq, value: 125 MHz}
...
- {id: CCM.SEMC_PODF.scale, value: '4'}
...
sources:
- {id: IOMUXC_GPR.SAI1_MCLK_EXT.outFreq, value: 12.288 MHz}
 ...
 ******************************************************************************/
FLASHMEM void BOARD_BootClockRUN(void) // ! FLASHMEM
{
