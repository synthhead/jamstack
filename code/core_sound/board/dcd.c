...
const uint8_t dcd_data[] = {
	...
	/* #3.1-85, command header bytes for merged 'Write - value' command */
	0xCC, 0x02, 0xAC, 0x04,
	...
	/* group: 'SEMC Init' */
	/* #1, command: write_set_bits, address: SEMC_MCR, value: 0x1, size: 4 */
	0xCC, 0x00, 0x0C, 0x1C, 0x40, 0x2F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
	/* #2, command: check_all_bits_clear, address: SEMC_MCR, value: 0x1, size: 4 */
	0xCF, 0x00, 0x0C, 0x04, 0x40, 0x2F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
	/* #3.1-3, command header bytes for merged 'Write - value' command */
	0xCC, 0x00, 0x1C, 0x04,
	/* #3.1, command: write_value, address: SEMC_MCR, value: 0x6, size: 4 */
	0x40, 0x2F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06,
	/* #3.2, command: write_value, address: SEMC_BMCR0, value: 0x0, size: 4 */
	0x40, 0x2F, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00,
	/* #3.3, command: write_value, address: SEMC_BMCR1, value: 0x0, size: 4 */
	0x40, 0x2F, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x00,
	/* #4, command: write_clear_bits, address: SEMC_MCR, value: 0x2, size: 4 */
	0xCC, 0x00, 0x0C, 0x0C, 0x40, 0x2F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
	/* #5.1-12, command header bytes for merged 'Write - value' command */
	0xCC, 0x00, 0x64, 0x04,
	/* #5.1, command: write_value, address: SEMC_BR0, value: 0x80000001, size: 4 */
	0x40, 0x2F, 0x00, 0x10, 0x80, 0x00, 0x00, 0x01,
	/* #5.2, command: write_value, address: SEMC_BR1, value: 0x8400001c, size: 4 */
	0x40, 0x2F, 0x00, 0x14, 0x84, 0x00, 0x00, 0x1C,
	/* #5.3, command: write_value, address: SEMC_BR2, value: 0x8800001c, size: 4 */
	0x40, 0x2F, 0x00, 0x18, 0x88, 0x00, 0x00, 0x1C,
	/* #5.4, command: write_value, address: SEMC_BR3, value: 0x8c00001c, size: 4 */
	0x40, 0x2F, 0x00, 0x1C, 0x8C, 0x00, 0x00, 0x1C,
	/* #5.5, command: write_value, address: SEMC_IOCR, value: 0x0, size: 4 */
	0x40, 0x2F, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
	/* #5.6, command: write_value, address: SEMC_SDRAMCR0, value: 0xf07, size: 4 */
	0x40, 0x2F, 0x00, 0x40, 0x00, 0x00, 0x0F, 0x07,
	/* #5.7, command: write_value, address: SEMC_SDRAMCR1, value: 0x220711, size: 4 */
	0x40, 0x2F, 0x00, 0x44, 0x00, 0x22, 0x07, 0x11,
	/* #5.8, command: write_value, address: SEMC_SDRAMCR2, value: 0x40404, size: 4 */
	0x40, 0x2F, 0x00, 0x48, 0x00, 0x04, 0x04, 0x04,
	/* #5.9, command: write_value, address: SEMC_SDRAMCR3, value: 0x0, size: 4 */
	0x40, 0x2F, 0x00, 0x4C, 0x00, 0x00, 0x00, 0x00,
	/* #5.10, command: write_value, address: SEMC_IPCR1, value: 0x2, size: 4 */
	0x40, 0x2F, 0x00, 0x94, 0x00, 0x00, 0x00, 0x02,
	/* #5.11, command: write_value, address: SEMC_IPCR2, value: 0x0, size: 4 */
	0x40, 0x2F, 0x00, 0x98, 0x00, 0x00, 0x00, 0x00,
	/* #5.12, command: write_value, address: SEMC_IPCR0, value: 0x80000000, size: 4 */
	0x40, 0x2F, 0x00, 0x90, 0x80, 0x00, 0x00, 0x00,
	/* #6, command: write_set_bits, address: SEMC_INTR, value: 0x1, size: 4 */
	0xCC, 0x00, 0x0C, 0x1C, 0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #7, command: write_value, address: SEMC_IPCMD, value: 0xa55a000f, size: 4 */
	0xCC, 0x00, 0x0C, 0x04, 0x40, 0x2F, 0x00, 0x9C, 0xA5, 0x5A, 0x00, 0x0F,
	/* #8, command: check_all_bits_set, address: SEMC_INTR, value: 0x1, size: 4 */
	0xCF, 0x00, 0x0C, 0x14, 0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #9.1-2, command header bytes for merged 'Write - value' command */
	0xCC, 0x00, 0x14, 0x04,
	/* #9.1, command: write_value, address: SEMC_INTR, value: 0x1, size: 4 */
	0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #9.2, command: write_value, address: SEMC_IPCMD, value: 0xa55a000c, size: 4 */
	0x40, 0x2F, 0x00, 0x9C, 0xA5, 0x5A, 0x00, 0x0C,
	/* #10, command: check_all_bits_set, address: SEMC_INTR, value: 0x1, size: 4 */
	0xCF, 0x00, 0x0C, 0x14, 0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #11.1-2, command header bytes for merged 'Write - value' command */
	0xCC, 0x00, 0x14, 0x04,
	/* #11.1, command: write_value, address: SEMC_INTR, value: 0x1, size: 4 */
	0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #11.2, command: write_value, address: SEMC_IPCMD, value: 0xa55a000c, size: 4 */
	0x40, 0x2F, 0x00, 0x9C, 0xA5, 0x5A, 0x00, 0x0C,
	/* #12, command: check_all_bits_set, address: SEMC_INTR, value: 0x1, size: 4 */
	0xCF, 0x00, 0x0C, 0x14, 0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #13.1-3, command header bytes for merged 'Write - value' command */
	0xCC, 0x00, 0x1C, 0x04,
	/* #13.1, command: write_value, address: SEMC_INTR, value: 0x1, size: 4 */
	0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #13.2, command: write_value, address: SEMC_IPTXDAT, value: 0x30, size: 4 */
	0x40, 0x2F, 0x00, 0xA0, 0x00, 0x00, 0x00, 0x30,
	/* #13.3, command: write_value, address: SEMC_IPCMD, value: 0xa55a000a, size: 4 */
	0x40, 0x2F, 0x00, 0x9C, 0xA5, 0x5A, 0x00, 0x0A,
	/* #14, command: check_all_bits_set, address: SEMC_INTR, value: 0x1, size: 4 */
	0xCF, 0x00, 0x0C, 0x14, 0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #15, command: write_value, address: SEMC_INTR, value: 0x1, size: 4 */
	0xCC, 0x00, 0x0C, 0x04, 0x40, 0x2F, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01,
	/* #16, command: write_set_bits, address: SEMC_SDRAMCR3, value: 0x1, size: 4 */
	0xCC, 0x00, 0x0C, 0x1C, 0x40, 0x2F, 0x00, 0x4C, 0x00, 0x00, 0x00, 0x01
	};
