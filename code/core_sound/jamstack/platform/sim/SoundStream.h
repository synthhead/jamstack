...
public:
  ...
  int             processorUsage(void) { return 0; }
  int             processorUsageMax(void) { return 0; }
  ...
  virtual void    parameter(int param, int value) {}
  virtual void    parameter(int param, float value) {}
